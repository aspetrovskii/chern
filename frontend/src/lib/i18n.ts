...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    auth_spotify_hint: "Authentication is now available only through Spotify.",
  ...
  ru: {
    ...
    auth_spotify_hint: "Авторизация теперь доступна только через Spotify.",
  ...
  tr: {
    ...
    auth_spotify_hint: "Kimlik doğrulama artık yalnızca Spotify ile kullanılabilir.",
  ...
  hi: {
    ...
    auth_spotify_hint: "अब लॉगिन केवल Spotify के माध्यम से उपलब्ध है।",
  ...
  zh: {
    ...
    auth_spotify_hint: "现在仅支持通过 Spotify 进行登录。",
